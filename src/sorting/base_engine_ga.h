#ifndef MEGAHIT_BASE_ENGINE_GA_H
#define MEGAHIT_BASE_ENGINE_GA_H
 ...
 */
class BaseSequenceSortingEngineGA {
 public:
 ...
 public:
  BaseSequenceSortingEngineGA(int64_t mem, int mem_flag, int n_threads, MPIEnviroment &mpienv)
      : host_mem_(mem), mem_flag_(mem_flag), n_threads_(n_threads), mpienv_(mpienv) {};

  BaseSequenceSortingEngineGA(int64_t mem, int mem_flag, int n_threads)
      : host_mem_(mem), mem_flag_(mem_flag), n_threads_(n_threads) {};
      
  virtual ~BaseSequenceSortingEngineGA() = default;
 ...
 protected:
  ...
  class OffsetFiller {
   public:
    OffsetFiller(BaseSequenceSortingEngineGA *engine, unsigned start_bucket,
   ...
   private:
   BaseSequenceSortingEngineGA *engine_;
  ...
  class OffsetFetcher {
   public:
    OffsetFetcher(BaseSequenceSortingEngineGA *engine, unsigned start_bucket,
                  unsigned end_bucket)
