...
#ifndef MEGAHIT_KMER_COUNTER_GA_H
#define MEGAHIT_KMER_COUNTER_GA_H
...
class KmerCounterGA : public BaseSequenceSortingEngineGA {
 public:
  static const unsigned kSentinelValue = 4;
  static const uint32_t kSentinelOffset = 4294967295U;
  explicit KmerCounterGA(const KmerCounterOptionGA &opt, MPIEnviroment &mpienv)
      : BaseSequenceSortingEngineGA(opt.host_mem, opt.mem_flag, opt.n_threads, mpienv),
        opt_(opt) {}
  ~KmerCounterGA() final = default;
