...
static std::pair<int64_t, int64_t> AdjustItemNumbers(int64_t mem_avail,
  ...
  if (mem_avail < min_lv1_items * SeqBaseSequenceSortingEngine::kLv1BytePerItem +
  ...
  while (num_lv1_items < num_lv2_items || num_lv1_items < min_lv1_items ||
    ...
    num_lv1_items = (mem_avail - bytes_per_lv2_item * num_lv2_items) /
                    SeqBaseSequenceSortingEngine::kLv1BytePerItem;
...
void SeqBaseSequenceSortingEngine::AdjustMemory() {
...
void SeqBaseSequenceSortingEngine::Run() {
...
void SeqBaseSequenceSortingEngine::Lv0PrepareThreadPartition() {
...
void SeqBaseSequenceSortingEngine::Lv0ReorderBuckets() {
...
unsigned SeqBaseSequenceSortingEngine::Lv1FindEndBuckets(unsigned start_bucket) {
...
void SeqBaseSequenceSortingEngine::Lv1ComputeThreadBegin() {
...
void SeqBaseSequenceSortingEngine::Lv0CalcBucketSizeLaunchMt() {
  SimpleTimer lv1_timer;
  lv1_timer.reset();
  lv1_timer.start();
...
void SeqBaseSequenceSortingEngine::Lv1FetchAndSortLaunchMt() {
...
void SeqBaseSequenceSortingEngine::Lv2Sort(
    SeqBaseSequenceSortingEngine::Lv2ThreadStatus *thread_status, unsigned b,
    int tid) {
...
void SeqBaseSequenceSortingEngine::Lv1FillOffsetsLaunchMt() {
